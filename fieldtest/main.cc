...
int main() {
    ...
    // 测量加法性能
    {
        ...
        std::cout << "Average time for addition: " << avg_time << " ns" << std::endl;
    }
    ...
    // 测量减法性能
    {
        ...
        auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start).count();
        double avg_time = duration / static_cast<double>(iterations);
        std::cout << "Average time for subtraction: " << avg_time << " ns" << std::endl;
    }
    ...
    // 测量乘法性能
    {
        ...
        auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start).count();
        double avg_time = duration / static_cast<double>(iterations);
        std::cout << "Average time for multiplication: " << avg_time << " ns" << std::endl;
    }
    ...
    // 测量除法性能
    {
        ...
        auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start).count();
        double avg_time = duration / static_cast<double>(iterations);
        std::cout << "Average time for division: " << avg_time << " ns" << std::endl;
    }
    ...
    // 测量求逆性能
    {
        ...
        auto duration = std::chrono::duration_cast<std::chrono::nanoseconds>(end - start).count();
        double avg_time = duration / static_cast<double>(iterations);
        std::cout << "Average time for inversion: " << avg_time << " ns" << std::endl;
