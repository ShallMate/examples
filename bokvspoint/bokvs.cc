...
bool OKVSBK::Encode(std::vector<yacl::math::MPInt> keys,std::vector<uint32_t> values){
    auto n = this->n_;
    auto b =this->b_;
    auto r = this->r_;
    auto w = this->w_;
...
void OKVSBK::Decode(std::vector<yacl::math::MPInt> keys, std::vector<uint32_t>& values) {
    auto b =this->b_;
    auto r = this->r_;
    auto w = this->w_;
    auto p = this->p_;
...
void OKVSBK::DecodeSingle(std::vector<yacl::math::MPInt> keys, std::vector<uint32_t>& values) {
    auto b =this->b_;
    auto r = this->r_;
    auto w = this->w_;
    auto p = this->p_;
