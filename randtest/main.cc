...
void RunTests() {
    ...
    std::cout << "FastRandU64 results: " << tmp1_u64 << " " << tmp2_u64 << std::endl;

    tmp1_u64 = yacl::crypto::SecureRandU64();
    tmp2_u64 = yacl::crypto::SecureRandU64();
    std::cout << "SecureRandU64 results: " << tmp1_u64 << " " << tmp2_u64 << std::endl;

    auto tmp1_u128 = yacl::crypto::FastRandU128();
    auto tmp2_u128 = yacl::crypto::FastRandU128();
    std::cout << "FastRandU128 results: " << tmp1_u128 << " " << tmp2_u128 << std::endl;
